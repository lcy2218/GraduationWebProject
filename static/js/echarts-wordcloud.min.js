            ...
            638: (t, e, a) => {
                ...
                o.extendSeriesModel({
                    ...
                    getInitialData: function (t, e) {
                        var a = o.helper.createDimensions(t.data, {coordDimensions: ["value"]}),
                            i = new o.List(a, this);
                    ...
                    type: "wordCloud", render: function (t, e, a) {
                        var i = this.group;
                        i.removeAll();
                        var r = t.getData(), n = t.get("gridSize");
                        t.layoutInstance.ondraw = function (e, a, s, l) {
                            var d = r.getItemModel(s), u = d.getModel("textStyle"), f = new o.graphic.Text({
                ...
                var i = function () {
                    ...
                    if (i) {
                        ...
                        if (e) for (var o in e) o in a && (a[o] = e[o]);
                        ...
                        var l, d, u, f, c, h, m, g = a.gridSize, v = g - a.maskGapWidth,
                            w = Math.abs(a.maxRotation - a.minRotation), p = Math.min(a.maxRotation, a.minRotation),
                            y = a.rotationStep;
                        switch (a.color) {
                            case"random-dark":
                                m = function () {
                        ...
                        var M, S = !1, b = [], I = function (t) {
                            var e, a, o = t.currentTarget, i = o.getBoundingClientRect();
                            t.touches ? (e = t.touches[0].clientX, a = t.touches[0].clientY) : (e = t.clientX, a = t.clientY);
                            var r = e - i.left, n = a - i.top, s = Math.floor(r * (o.width / i.width || 1) / g),
                        ...
                        !function () {
                            ...
                            if (D("wordcloudstart", !0)) {
                                ...
                                })), i = d; i--;) for (l[i] = [], s = u; s--;) l[i][s] = !0; else {
                                    var R = document.createElement("canvas").getContext("2d");
                                    R.fillStyle = a.backgroundColor, R.fillRect(0, 0, 1, 1);
                                    var A, z, F = R.getImageData(0, 0, 1, 1).data,
                                        L = e.getContext("2d").getImageData(0, 0, d * g, u * g).data;
                                    for (i = d; i--;) for (l[i] = [], s = u; s--;) {
                                        z = g;
                                        t:for (; z--;) for (A = g; A--;) for (v = 4; v--;) if (L[4 * ((s * g + z) * d * g + (i * g + A)) + v] !== F[v]) {
                                            l[i][s] = !1;
                                            break t
                                        }
                                        !1 !== l[i][s] && (l[i][s] = !0)
                                ...
                                v = 0;
                                var W = !0;
                                a.layoutAnimation ? 0 !== a.wait ? (I = window.setTimeout, E = window.clearTimeout) : (I = window.setImmediate, E = window.clearImmediate) : (I = function (t) {
                                    t()
                                }, E = function () {
                                    W = !1
                                });
                                        ...
                                        var o = function (e) {
                                            ...
                                            var f, h, v,
                                                ...
                                                b = function (t, e, o) {
                                                    ...
                                                    if (O()) return !1;
                                                    for (var b, I, T, C = [], E = y, k = [p / 2, y / 2, p / 2, y / 2]; E--;) for (b = p; b--;) {
                                                        T = g;
                                                        t:for (; T--;) for (I = g; I--;) if (S[4 * ((b * g + T) * x + (E * g + I)) + 3]) {
                                                    ...
                                                    var D = (f = C[E], h = void 0, v = void 0, h = Math.floor(f[0] - b.gw / 2), v = Math.floor(f[1] - b.gh / 2), b.gw, b.gh, !!function (t, e, o, i, r) {
                                                        ...
                                                        v[3], v[0], v[1], v[3], v[2], v[0], t.forEach((function (t) {
                                                            if (t.getContext) {
                                                                ...
                                                                for (var w in f && (v.color = f), l.textContent = r, v) l.style[w] = v[w];
                                                                if (u) for (var p in u) l.setAttribute(p, u[p]);
                                                                c && (l.className += c), t.appendChild(l)
                                                            }
                                                        }))
                                                    }(h, v, b, o, i, c - T, f[2], M, s), function (e, o, i, r, n, s) {
                                                        var l, f, c = n.occupied, h = a.drawMask;
                                                        ...
                                                        h && l.restore()
                                                    }(h, v, 0, 0, b, e), {gx: h, gy: v, rot: M, info: b}));
                                                    if (D) return D
                                                }
                                            }
                                            return null
                                        }(a.list[v]), i = !D("wordclouddrawn", !0, {item: a.list[v], drawn: o});
                ...
                o.registerLayout((function (t, e) {
                    t.eachSeriesByType("wordCloud", (function (a) {
                        var i = o.helper.getLayoutRect(a.getBoxLayoutParams(), {
                            width: e.getWidth(),
                            height: e.getHeight()
                        }), r = a.getData(), n = document.createElement("canvas");
                        n.width = i.width, n.height = i.height;
                        var s = n.getContext("2d"), d = a.get("maskImage");
                        if (d) try {
                            s.drawImage(d, 0, 0, n.width, n.height), function (t) {
                                for (var e = t.getContext("2d"), a = e.getImageData(0, 0, t.width, t.height), o = e.createImageData(a), i = 0, r = 0, n = 0; n < a.data.length; n += 4) a.data[n + 3] > 128 && (i += l = a.data[n] + a.data[n + 1] + a.data[n + 2], ++r);
                                var s = i / r;
                        ...
                        var u = a.get("sizeRange"), f = a.get("rotationRange"), c = r.getDataExtent("value"),
                            h = Math.PI / 180, m = a.get("gridSize");
